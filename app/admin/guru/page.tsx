  ...
  return (
    <div className="space-y-6 lg:space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-12">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="text-[24px] sm:text-[28px] font-medium text-slate-800 tracking-tight">Manajemen Guru</h2>
      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-none overflow-hidden">
        <div className="p-5 sm:p-6 lg:p-8 border-b border-slate-50 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-[16px] sm:text-[18px] font-medium text-slate-800">Data Guru</h3>
          </div>
          ...
          <table className="w-full text-left border-collapse min-w-[900px]">
            <thead>
              <tr className="bg-white">
                <th className="px-6 py-4 text-[12px] font-medium text-slate-400 uppercase tracking-wider">NIP</th>
                <th className="px-6 py-4 text-[12px] font-medium text-slate-400 uppercase tracking-wider">Nama Guru</th>
                <th className="px-6 py-4 text-[12px] font-medium text-slate-400 uppercase tracking-wider">Mata Pelajaran</th>
                <th className="px-6 py-4 text-[12px] font-medium text-slate-400 uppercase tracking-wider">Kontak</th>
                <th className="px-6 py-4 text-[12px] font-medium text-slate-400 uppercase tracking-wider text-center">Siswa</th>
            ...
            <tbody className="divide-y divide-slate-50 bg-white">
              {loading ? (
                ...
                <tr>
                  <td colSpan={7} className="px-6 py-16 text-center text-slate-400 font-medium bg-slate-50/20">
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <span className="text-[14px] font-medium text-slate-400">Tidak ada data guru ditemukan.</span>
                    </div>
                  </td>
                </tr>
              ) : teachers.map((guru) => (
                <tr key={guru.id} className="hover:bg-slate-50/30 transition-colors group">
                  <td className="px-6 py-5">
                    <span className="text-[13px] sm:text-[14px] font-medium text-slate-700 font-mono tracking-tight">{guru.nip}</span>
                  </td>
                  <td className="px-6 py-5">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-[14px] font-medium text-slate-800">{guru.nama}</span>
                    </div>
                  </td>
                  <td className="px-6 py-5">
                    <span className="text-[14px] font-semimedium text-slate-700">{guru.mataPelajaran}</span>
                  </td>
                  <td className="px-6 py-5">
                  ...
                  <td className="px-6 py-5 text-center">
                    <span className={`px-2.5 py-1 text-[10px] font-medium uppercase tracking-wider rounded-[4px] shadow-sm ${guru.totalSiswa > 0 ? "bg-[#854D0E]/10 text-[#854D0E] border border-[#854D0E]/20" : "bg-[#854D0E] text-white"}`}>
